function NavBarBottom() {
    return (
        <div className="fixed bottom-0 z-50 w-full h-20 -translate-x-1/2 bg-white border border-gray-200 left-1/2  dark:border-gray-600">
            <div className="grid h-full grid-cols-3 mx-auto">
                <button data-tooltip-target="tooltip-home" type="button" className="inline-flex flex-col items-center justify-center px-5 hover:bg-white group">
                    <svg className="w-7 h-7 mb-1 text-gray-500 text-black group-hover:text-orange-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                ...
                <button data-tooltip-target="tooltip-profile" type="button" className="inline-flex flex-col items-center justify-center px-5  group">
                    <svg className="w-8 h-8 mb-1 dark:text-black group-hover:text-orange-600 dark:group-hover:text-orange-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
